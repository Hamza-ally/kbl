                ...
                <div class="form-container">
                    ...
                    <form action="{{ route('customers.edit') }}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="cnic" name="cnic" value="{{$customer['cnic']}}" required>
                            @if ($errors->has('cnic'))
                                <div class="alert alert-danger" role="alert">
                                    {{ $errors->first('cnic') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" id="conn_id" name="conn_id" value="{{$customer['conn_id']}}"
                                required>
                        ...
                        <div class="form-group">
                            ...
                            <select id="package_type" name="package_type" required>
                                ...
                                <option value="basic" @if($customer['package_type'] === 'basic') selected @endif>Basic</option>
                                <option value="premium" @if($customer['package_type'] === 'premium') selected @endif>Premium</option>
                                <option value="enterprise" @if($customer['package_type'] === 'enterprise') selected @endif>Enterprise</option>
                            </select>
